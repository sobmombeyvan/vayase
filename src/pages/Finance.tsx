...
import { Wallet, TrendingUp, Clock, AlertCircle, Receipt } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <KPICard label={t('finance.pendingAmount')} value={formatCurrency(pending)} icon={Clock} accent="warning" />
      ...
      <div className="vayase-card overflow-hidden">
        ...
        <div className="overflow-x-auto scrollbar-thin">
          <table className="w-full">
            ...
            <tbody>
              {payments.length === 0 && (
                <tr><td colSpan={7} className="text-center py-12 text-muted-foreground text-sm">{t('common.noData')}</td></tr>
              )}
              {payments.map((p, i) => (
                <motion.tr key={p.id}
