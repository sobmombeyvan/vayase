  ...
  fr: {
    translation: {
      ...
      chat: {
        ...
        voicePermissionDenied: 'Autorisez le micro dans les réglages du navigateur',
        voiceUnsupported: 'Enregistrement vocal non supporté sur cet appareil',
        voiceTooShort: 'Message vocal trop court',
  ...
  en: {
    translation: {
      ...
      chat: {
        ...
        voiceUnsupported: 'Voice recording not supported on this device',
        voiceTooShort: 'Voice message too short',
